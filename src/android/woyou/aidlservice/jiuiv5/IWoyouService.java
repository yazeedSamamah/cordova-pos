...
{
data.enforceInterface(DESCRIPTOR);
sunmi.TransBean[] _arg0;
_arg0 = data.createTypedArray(sunmi.TransBean.CREATOR);
woyou.aidlservice.jiuiv5.ICallback _arg1;
_arg1 = woyou.aidlservice.jiuiv5.ICallback.Stub.asInterface(data.readStrongBinder());
...
/**
	...
	* Ver 1.8.0中增加
	*/
@Override public void commitPrint(sunmi.TransBean[] transbean, woyou.aidlservice.jiuiv5.ICallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* Ver 1.8.0中增加
	*/
public void commitPrint(sunmi.TransBean[] transbean, woyou.aidlservice.jiuiv5.ICallback callback) throws android.os.RemoteException;
/**
	* 打印缓冲区内容
	*/
